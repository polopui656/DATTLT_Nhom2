...
def generate_random_multithreaded():
    ...
    def update_ui():
        if not data:
            ...
            status_label.config(
                text="Invalid input! Please check your values.", fg="red"
            )
        else:
...
def draw_bars_multithreaded(data, chart_area, color_array=None):
    def draw():
        draw_bars(data, chart_area, color_array)  # Chỉ vẽ thanh, không xóa lại
...
def update_all_result_labels(result_text):
    # Update result labels for all tabs
    result_label_tab1.config(text=result_text)
    result_label_tab2_1.config(text=result_text)
    result_label_tab2_2.config(text=result_text)
    result_label_tab3_1.config(text=result_text)
    result_label_tab3_2.config(text=result_text)
    result_label_tab3_3.config(text=result_text)
...
def run_sorting_algorithm(selected_algo, data, chart_area, time_label, thread_id):
    ...
    try:
        ...
        update_all_result_labels(result_text)
        if time_label:
...
start_sorting_button = ttk.Button(
    input_frame, text="Start Sorting", command=start_sorting
)
...
algo_dropdown3_1.set("Selection Sort")
...
algo_dropdown3_2.set("Bubble Sort")
...
algo_dropdown3_3.set("Insertion Sort")
...
bottom_frame_tab1 = tk.Frame(chart_area_tab1, bg="white")
bottom_frame_tab1.pack(side=tk.BOTTOM, fill=tk.X)
result_label_tab1 = tk.Label(
    bottom_frame_tab1,
    text="Result:\nTime: \nNumbers: ",
    font=("Helvetica", 12),
    bg="white",
...
result_label_tab1.pack(side=tk.LEFT, padx=10)

bottom_frame_tab2_1 = tk.Frame(chart_area_tab2_1, bg="white")
bottom_frame_tab2_1.pack(side=tk.BOTTOM, fill=tk.X)
result_label_tab2_1 = tk.Label(
    bottom_frame_tab2_1,
    text="Result:\nTime: \nNumbers: ",
    font=("Helvetica", 12),
    bg="white",
...
result_label_tab2_1.pack(side=tk.LEFT, padx=10)

bottom_frame_tab2_2 = tk.Frame(chart_area_tab2_2, bg="white")
bottom_frame_tab2_2.pack(side=tk.BOTTOM, fill=tk.X)
result_label_tab2_2 = tk.Label(
    bottom_frame_tab2_2,
    text="Result:\nTime: \nNumbers: ",
    font=("Helvetica", 12),
    bg="white",
...
result_label_tab2_2.pack(side=tk.LEFT, padx=10)

bottom_frame_tab3_1 = tk.Frame(chart_area_tab3_1, bg="white")
bottom_frame_tab3_1.pack(side=tk.BOTTOM, fill=tk.X)
result_label_tab3_1 = tk.Label(
    bottom_frame_tab3_1,
    text="Result:\nTime: \nNumbers: ",
    font=("Helvetica", 12),
    bg="white",
...
result_label_tab3_1.pack(side=tk.LEFT, padx=10)

bottom_frame_tab3_2 = tk.Frame(chart_area_tab3_2, bg="white")
bottom_frame_tab3_2.pack(side=tk.BOTTOM, fill=tk.X)
result_label_tab3_2 = tk.Label(
    bottom_frame_tab3_2,
    text="Result:\nTime: \nNumbers: ",
    font=("Helvetica", 12),
    bg="white",
...
result_label_tab3_2.pack(side=tk.LEFT, padx=10)

bottom_frame_tab3_3 = tk.Frame(chart_area_tab3_3, bg="white")
bottom_frame_tab3_3.pack(side=tk.BOTTOM, fill=tk.X)
result_label_tab3_3 = tk.Label(
    bottom_frame_tab3_3,
    text="Result:\nTime: \nNumbers: ",
    font=("Helvetica", 12),
    bg="white",
...
result_label_tab3_3.pack(side=tk.LEFT, padx=10)
# Bắt đầu Giao diện
win.mainloop()
